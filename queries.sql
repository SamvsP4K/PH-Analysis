...
--Management per department retirement info
...
--Sales team info
SELECT retirement_info.emp_no, retirement_info.first_name,retirement_info.lastname, departments.dept_no, departments.dept_name,dept_emp.emp_no
FROM retirement_info
